...
assert(resolveInterfaceLocale('de_DE', 'en-US')==='de', 'Underscore-delimited Tableau locales should select German.');
...
assert(
    translate('en', 'Selected {label}', { label: '$1, $&, $$' })==='Selected $1, $&, $$',
    'Interpolation values containing replacement tokens should be inserted literally.'
);
